...
VALUES 
('Juan', '6681111415', '24020034@uadeo.com', 'Calle Pedro Anaya #312'),

INSERT INTO Producto (Nombre, Tipo, Precio, Disponibilidad)
VALUES
('Taco Adobada', 'taco de maíz', 25.00, 1),
('Agua de Horchata', 'bebida', 15.00, 1),
('Agua de Limon', 'bebida', 15.00, 1),
('Taco de birria', 'taco de harina', 30.00, 1);
...
VALUES
('Garcia Ramírez', 'Cocinero', 'Matutino', '6681112233'),
('Nenuco Suarez', 'Cocinero', 'Matutino', '6681112233'),
('Liliana Torres', 'Cajera', 'Vespertino', '6682223344');
